...
class AppColors {
  // Primary Brand Colors (from BebaMart logo - dark navy blue)
  static const Color primary = Color(0xFF1A1A4E);
  static const Color primaryDark = Color(0xFF0F0F2D);
  static const Color primaryLight = Color(0xFF2D2D6B);
  ...
  static const LinearGradient primaryGradient = LinearGradient(
    ...
    colors: [primary, Color(0xFF312E81)],
  );
